...
#### Function13 <- paste0(FolderRoute,"/01Functions/PkAnnotation.r")
#### source(Function13)
#### AnnotationResult <- PkAnnotation(TemplateIndex, NormTemplateMS, TemplateName, UniquePkLabelNum, MS4LabeledPk, ExamMzNum)

PkAnnotation <- function(TemplateIndex, NormTemplateMS, TemplateName, UniquePkLabelNum, MS4LabeledPk, ExamMzNum){

AnnotationResult <- matrix(0, nrow = 3,ncol = 6)
rownames(AnnotationResult) <- c("MzExistance", "MzSequence", "MassSimilarity")
colnames(AnnotationResult) <- c("MatchRule", "TemplateIndex", "TemplateName", "UniquePkLabel", "PixelIndexNum", "MatchResult")
...
AnnotationResult["MzExistance", "TemplateName"] <- TemplateName
break 
}
}
...
AnnotationResult["MzSequence", "TemplateName"] <- TemplateName
break 
}
}
...
AnnotationResult["MassSimilarity", "TemplateName"] <- TemplateName
break 
}
}
